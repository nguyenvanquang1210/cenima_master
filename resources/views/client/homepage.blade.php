                ...
                <div class="row gallery-active">
                    <div class="col-12">
                        <div class="gallery-item">
                            <img src="/assets_client/img/images/avata2.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="gallery-item">
                            <img src="/assets_client/img/images/sieulua.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="gallery-item">
                            <img src="/assets_client/img/images/onepiece.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="copyright-text">
                            <p>Copyright &copy;  @php echo date('Y') @endphp . All Rights Reserved By <a href="/assets_client/index.html">WuangWang</a></p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
